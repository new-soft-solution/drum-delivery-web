        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <DetailRow
              ...
              value={
                <StatusBadge
                  status={DRUM_STATUS_LABELS[drum.status] ?? drum.status}
                />
              }
              icon="ri-radar-line"
            />
          ...
          <div className="col-md-6">
            <DetailRow
              label="Length"
              value={`${drum.length_kms} KMs`}
              icon="ri-ruler-line"
            />
            <DetailRow
              label="Net Weight"
              value={`${drum.net_weight_mt} MT`}
              icon="ri-scales-3-line"
            />
            <DetailRow
              label="Gross Weight"
              value={`${drum.gross_weight_mt} MT`}
              icon="ri-scales-3-line"
            />
          </div>
        </div>
